...
public class EmailServiceImpl implements EmailService {
	...
	private static final String EMAIL_WELCOME_SUBJECT = "Welcome to Netflix";
	private static final String EMAIL_FORGOT_PASSWORD = " Netflix - New Password";
	...
	public void sendEmail(ServletContext context, User recipient, String type) {
	       ...
	       try {
			...
			case "forgot" :
				...
				default:
					subject = "Netflix";
					content = "Maybe this email wrong, don't care about it";
