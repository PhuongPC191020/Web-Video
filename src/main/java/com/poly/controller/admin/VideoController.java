...
public class VideoController extends HttpServlet {
	...
	//asm-java4/admin/video?aaction=view
	private void doGetOverView(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher requestDispatcher = req.getRequestDispatcher("/views/admin/videooverview.jsp");
		requestDispatcher.forward(req, resp);
	}
	
	//asm-java4/admin/video?aaction=delete&href={href}
	...
	private void doGetAdd(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		RequestDispatcher requestDispatcher = req.getRequestDispatcher("/views/admin/videoedit.jsp");
		requestDispatcher.forward(req, resp);
	}
	//asm-java4/admin/video?aaction=edit&href={href}
	...
	//asm-java4/admin/video?aaction=update
