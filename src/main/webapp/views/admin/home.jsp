...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Admin Phương </span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">${sessionScope.currenUser.username}</a>
        </div>
      </div>
          ...
          <li class="nav-item menu-open">
           ...
           <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="admin/v ideo?action=add" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>New or Edit</p>
                </a>
              </li>
              		...
              		<tbody>
              			<c:forEach items="${videos}" var="item">
              				<tr>
              					<td>${item.title}</td>
              					<td>${item.href}</td>
              					<td><a href="video?action=watch&id=${item.href}">${item.totalLike}</a></td>
              				</tr>
              			</c:forEach>
                  </tbody>
...
<script>
  ...
  $('#selectVideo').change(function(){
	    ...
	    $.ajax({
	        ...
	        $('#example2').DataTable().clear().destroy(); // Xóa và loại bỏ bảng DataTable cũ (nếu có)
	        $('#example2').DataTable({
	            "paging": true,
	            "lengthChange": false,
	            "searching": false,
